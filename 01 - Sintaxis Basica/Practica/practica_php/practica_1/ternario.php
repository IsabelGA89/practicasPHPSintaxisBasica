<?php
function genera_numero_aleatorio($min,$max){
    $num = rand($min, $max);
    return $num;
}

$num_aleatorio = genera_numero_aleatorio(1,1000);
...
<div class="container jumbotron">
    <div class="enunciado">
        ...
        <ul>
            <li>Usando el operador ternario obtén un número aleatorio de 1 a 1000 y visualiza
                con un texto si el número es par o impar .</li>
        </ul>
