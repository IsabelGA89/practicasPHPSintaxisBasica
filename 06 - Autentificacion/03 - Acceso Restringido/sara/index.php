...
<div id="login">
    <fieldset>
        <h1>Has accedido a la página de acceso restrigido a usuarios registrados</h1>
        <h2>Si has accedido aquí es porque perteneces estás en el fichero de usuarios registrados</h2>
