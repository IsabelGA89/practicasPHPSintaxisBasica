...
<div class="container">
    <div class="jumbotron">
        <div>Modifica el ejercicio anterior con una nueva opción llamada Leer</br>
            En este caso se leerá el fichero especificado si existe, y su contenido aparecerá en el textarea</br>
            En caso de no existir el fichero no se visualizará nada</br>
            En la parte superior del forumulario debe de aparecer un mensaje informativo según la acción que se esté ejecutando</br>
            <ol>
                <li>Inserte datos y seleccione opción</li>
                <li>Se ha creado el fichero especificado o no se ha podido crear el fichero</li>
                <li>Se ha leído el fichero especificado o no se ha podido leer</li>
            </ol>
        </div>
